...
for j=1:100
    ...
    Data=dlmread(fullfile('C:\project source file\Spectral Minutia\data\spectra_20180326145112', FileName1));
    Data =Data(1:end,:);
    ...
    for k=1:100
        ...
        Data2=dlmread(fullfile('C:\project source file\Spectral Minutia\data\spectra_20180326145112', FileName));
        Data2 =Data2(1:end,:);
        ...
        jpegToSaveFileName = fullfile('C:\project source file\Spectral Minutia\data\spectra_20180326145112\imp',FileName3);% use path if you want to save to same directory
...
for j=1:100
    ...
    jpegToSaveFileName = fullfile('C:\project source file\Spectral Minutia\data\spectra_20180326145112','gen.txt');% use path if you want to save to same directory
    dlmwrite(jpegToSaveFileName, Y);
    % length(Y)
    FileName
            ...
            try
                ...
                for k=[1,2,7,8]
                    try
                        ...
                        Data2=dlmread(fullfile('C:\project source file\Spectral Minutia\data\spectra_20180326145112', FileName2));
                        Data2 =Data2(1:end,:);
                        ...
                        FileName3=[num2str(j),BaseName1];
                        jpegToSaveFileName = fullfile('C:\project source file\Spectral Minutia\data\spectra_20180326145112\gen',FileName1);% use path if you want to save to same directory
                        dlmwrite(jpegToSaveFileName, Y);
                    catch ME
                        disp(k);
                    end
